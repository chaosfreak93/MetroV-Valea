...
{
    internal class ServerVehicleShops
    {
        public static List<Server_Vehicle_Shops> ServerVehicleShops_ = new();
        public static List<Server_Vehicle_Shops_Items> ServerVehicleShopsItems_ = new();
        ...
        public static string GetTabletVehicleStoreItems() {
            var items = ServerVehicleShopsItems_.Where(x => x.isOnlyOnlineAvailable).Select(x => new {
                x.shopId,
                name = ServerVehicles.GetVehicleNameOnHash(x.hash),
                manufactor = ServerVehicles.GetVehicleManufactorOnHash(x.hash),
                fueltype = ServerVehicles.GetVehicleFuelTypeOnHash(x.hash),
        ...
        public static Position GetVehicleShopOutPosition(int shopId) {
            ...
            if (shop != null)
                pos = new Position(shop.parkOutX, shop.parkOutY, shop.parkOutZ);
        ...
        public static Rotation GetVehicleShopOutRotation(int shopId) {
            ...
            if (shop != null)
                rot = new Rotation(shop.parkOutRotX, shop.parkOutRotY, shop.parkOutRotZ);
