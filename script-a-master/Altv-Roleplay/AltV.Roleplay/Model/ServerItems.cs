...
{
    internal class ServerItems
    {
        public static List<Server_Items> ServerItems_ = new();
        public static List<Server_Teleports> ServerTeleports_ = new();
        ...
        public static string ReturnNormalItemName(string itemName) {
            try {
                ...
                if (itemName.Contains("♂"))
                    normalName = itemName.Replace("♂", "-M-");
                else if (itemName.Contains("♀"))
                    normalName = itemName.Replace("♀", "-W-");
