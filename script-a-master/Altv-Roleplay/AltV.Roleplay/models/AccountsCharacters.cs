...
{
    public class AccountsCharacters
    {
        [Key]
        ...
        [NotMapped] public int targetNumber { get; set; } = 0;

        [NotMapped] public int CurrentlyRecieveCaller { get; set; } = 0;

        [NotMapped] public string currentFunkFrequence { get; set; } = null;
    }
}