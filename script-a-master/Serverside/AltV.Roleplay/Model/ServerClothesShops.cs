...
{
    internal class ServerClothesShops
    {
        public static List<Server_Clothes_Shops> ServerClothesShops_ = new();
        public static List<Server_Clothes_Shops_Items> ServerClothesShopsItems_ = new();
