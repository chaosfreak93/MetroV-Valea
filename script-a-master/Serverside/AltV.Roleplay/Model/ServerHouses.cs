...
{
    internal class ServerHouses
    {
        public static List<Server_Houses_Interiors> ServerHousesInteriors_ = new();
        public static List<Server_Houses> ServerHouses_ = new();
        public static List<Server_Houses_Storage> ServerHousesStorage_ = new();
        public static List<Server_Houses_Renter> ServerHousesRenter_ = new();

        internal static void CreateHouse(int id, int interiorId, int ownerId, string street, int price, int maxRenters, int rentPrice,
            bool isRentable, bool hasStorage, bool hasAlarm, bool hasBank, Position entrancePos, int money) {
            try {
                ...
                houseData.entranceShape.SetColShapeId(id);
