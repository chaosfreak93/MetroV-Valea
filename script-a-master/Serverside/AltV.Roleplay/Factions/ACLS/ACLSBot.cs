...
namespace Altv_Roleplay.Factions.ACLS
{
    internal class ACLSBot
    {
        ...
        public static void Main() {
            new ACLSBot().MainAsync().GetAwaiter().GetResult();
        }
        ...
        private async Task MainAsync() {
            ...
            _client.Ready += () =>
            {
                AltAsync.Log("ACLS Bot is connected!");
        ...
        {
            public static string token = "ODI4NjQyOTIxMTkxOTY0NzMy.YGsj2w.j77mSJ8hR9t_4QLs6R8ZR6fs-IY";
            public static ulong guild = 840995072362807299;
            public static ulong channel = 841207065259147274;
            public static ulong message = 841207111102103573;
            public static int factionId = 4;
        }
    }
}