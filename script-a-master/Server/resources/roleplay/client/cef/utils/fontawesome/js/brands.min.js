 ...
 */ !function() {
    ...
    var l = (c.navigator || {
    }).userAgent, h = void 0 === l ? "" : l, v = c, m = z, a = (v.document, !!m.documentElement && !!m.head && "function" == typeof m.addEventListener && m.createElement, ~h.indexOf("MSIE") || h.indexOf("Trident/"), "___FONT_AWESOME___"), M = function() {
        try {
            return !0;
        } catch (c1) {
            return !1;
    ...
    var H = s[a];
    function f(c1, h1) {
        var z1 = (2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {
        }).skipHooks, l1 = void 0 !== z1 && z1, v1 = Object.keys(h1).reduce(function(c2, z2) {
            var l2 = h1[z2];
            return !!l2.icon ? c2[l2.iconName] = l2.icon : c2[z2] = l2, c2;
        }, {
        });
        "function" != typeof H.hooks.addPack || l1 ? H.styles[c1] = (function(v2) {
            for(var c2 = 1; c2 < arguments.length; c2++){
                var m1 = null != arguments[c2] ? arguments[c2] : {
                }, z2 = Object.keys(m1);
                "function" == typeof Object.getOwnPropertySymbols && (z2 = z2.concat(Object.getOwnPropertySymbols(m1).filter(function(c3) {
                    return Object.getOwnPropertyDescriptor(m1, c3).enumerable;
                }))), z2.forEach(function(c3) {
                    var z3, l2, h2;
                    z3 = v2, h2 = m1[l2 = c3], l2 in z3 ? Object.defineProperty(z3, l2, {
                        value: h2,
                        enumerable: !0,
                        configurable: !0,
                        writable: !0
        ...
        }, v1) : H.hooks.addPack(c1, v1), "fas" === c1 && f("fa", h1);
    }
    var e = {
        "500px": [
            448,
