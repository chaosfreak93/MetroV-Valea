...
e2 = this, t = function(e) {
    ...
    var r = (n.navigator || {
    }).userAgent, i = void 0 === r ? "" : r, l = n, u = o, c = !!l.document, s = !!u.documentElement && !!u.head && "function" == typeof u.addEventListener && "function" == typeof u.createElement, f = (~i.indexOf("MSIE") || i.indexOf("Trident/"), []), d = !1;
    function m(e) {
    ...
    function E(e) {
        ...
        }, l.FontAwesomeDetection.nodesTested = t, l.FontAwesomeDetection.nodesFound = n, l.FontAwesomeDetection.detectionDone = !0;
    }
    function C() {
        ...
        }, e, o), i = Object.keys(e).length + Object.keys(o).length, c = l.FontAwesomeDetection.timeout + l.FontAwesomeDetection.resultsCollectionMaxWait;
    ...
    "exports"
], t) : t(e2["fontawesome-pro-conflict-detection"] = {
});
