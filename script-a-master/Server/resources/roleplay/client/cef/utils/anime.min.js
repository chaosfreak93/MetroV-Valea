 ...
 */ !function(n, e) {
    ...
    function s(n, e) {
        var r = c(n), o = a(i.und(r[0]) ? 1 : r[0], 0.1, 100), u = a(i.und(r[1]) ? 100 : r[1], 0.1, 100), s = a(i.und(r[2]) ? 10 : r[2], 0.1, 100), f = a(i.und(r[3]) ? 0 : r[3], 0.1, 100), l = Math.sqrt(u / o), d = s / (2 * Math.sqrt(u * o)), p = d < 1 ? l * Math.sqrt(1 - d * d) : 0, h = 1, v = d < 1 ? (d * l - f) / p : -f + l;
        function g(n) {
            var r = e ? e * n / 1000 : n;
        ...
        return function(r, t, a, i) {
            ...
            function f(t) {
                ...
                return d >= 0.001 ? (function(n, e, r, t) {
                    ...
                    for(var u, i, c = 0; (u = o(i = e + (r - e) / 2, t, a) - n) > 0 ? r = i : e = i, Math.abs(u) > 0.0000001 && ++c < 10;);
                    return i;
                })(t, i, i + e, r, a);
            }
        };
    ...
    function $(n, e) {
        var r = e || {
            ...
            return e;
        }(n), a = t.getBoundingClientRect(), o = P(t, "viewBox"), u = a.width, c = a.height, s = r.viewBox || (o ? o.split(" ") : [
            0,
            0,
            u,
            c
    ...
    function Y(n, e) {
        ...
        return {
            original: t,
            numbers: t.match(r) ? t.match(r).map(Number) : [
                0
            ],
