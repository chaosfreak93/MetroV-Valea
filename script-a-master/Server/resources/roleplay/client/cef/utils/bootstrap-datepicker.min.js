 ...
 */ !function(a, b) {
    ...
    j.prototype = {
        ...
        update: function() {
            ...
            }, this)), d = !0) : (c = this.isInput ? this.element.val() : this.element.data("date") || this.element.find("input").val(), c = c && this.o.multidate ? c.split(this.o.multidateSeparator) : [
                c
        ...
        fill: function() {
            ...
            if (!isNaN(f) && !isNaN(g)) {
                ...
                for(var C, D = a.map(this.dates, function(a) {
                    ...
                    "year"
                ], -1 === E ? C.push("old") : 10 === E && C.push("new"), -1 !== a.inArray(f, D) && C.push("active"), (h > f || f > j) && C.push("disabled"), t += '<span class="' + C.join(" ") + '">' + f + "</span>", f += 1;
                B.html(t);
            }
        },
    ...
    var l = a.fn.datepicker, m = function(c) {
        ...
        return this.each(function() {
            ...
            if (!i) {
                var m = g(this, "date"), o = a.extend({
                }, n, m, l), p = h(o.language), q = a.extend({
                }, n, p, m, l);
