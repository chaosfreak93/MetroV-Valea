...
class SingleRace {
    ...
    static setMainScreenCooldown(cooldown) {
    ...
    static async getMouseClickedButton() {
        let returnValue = -1;
        native.callScaleformMovieMethodWithNumber(scaleform, "SET_INPUT_EVENT", 237, -1082130432, -1082130432, -1082130432, -1082130432);
    ...
    static startRace() {
        ...
        native.scaleformMovieMethodAddParamFloat(0);
        native.endScaleformMovieMethod();
    }
    static async IsRaceFinished() {
    ...
    static async checkRaceWinStatus() {
        if (checkRaceStatus) {
