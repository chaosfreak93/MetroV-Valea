    ...
    for (var key in markerStreamer.markers) {
        ...
        if (marker.onDisplay) {
            natives.drawMarker(
                ...
                marker.color.r, marker.color.g, marker.color.b, marker.color.a, !!marker.bobUpDown, !!marker.faceCam, 2, !!marker.rotate, marker.textureDict, marker.textureName, !!marker.drawOnEnter
            );
        }
    }
});