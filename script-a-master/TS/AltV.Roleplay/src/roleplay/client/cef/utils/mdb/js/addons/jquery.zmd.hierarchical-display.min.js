!(function (t) {
    ...
    function (t, n, r) {
        ...
        t.exports = function (t, n) {
            var r,
                ...
                v = t.global,
                d = t.stat;
            if ((r = v ? e : d ? e[y] || u(y, {}) : (e[y] || {}).prototype))
                for (f in n) {
                    if (
                        ((p = n[f]),
        ...
        o("inspectSource", function (t) {
            ...
            (t.exports = function (t, n, r, o) {
                var a = !!o && !!o.unsafe,
                    ...
                    f = !!o && !!o.noTargetGet;
                "function" == typeof r &&
                    ("string" != typeof n || c(r, "name") || i(r, "name", n),
                    (l(r).source = p.join("string" == typeof n ? n : ""))),
                    t !== e
                        ? (a ? !f && t[n] && (s = !0) : delete t[n], s ? (t[n] = r) : i(t, n, r))
                        : s
                        ? (t[n] = r)
                        : u(n, r);
                ...
                return function (h, y, v, d) {
                    for (
                        var g,
                            ...
                            w = 0,
                            j = d || u,
                            _ = n ? j(h, O) : r ? j(h, 0) : void 0;
                        O > w;
                        w++
                    )
                        if ((p || w in S) && ((m = x((g = S[w]), w, b)), t))
                            if (n) _[w] = m;
                            else if (m)
                                switch (t) {
                                    case 3:
    ...
    function (t, n, r) {
        ...
        (t.exports =
            ...
            function (t, n) {
                var r;
                return (
                    null !== t ? ((f.prototype = e(t)), (r = new f()), (f.prototype = null), (r[s] = t)) : (r = l()),
                    void 0 === n ? r : o(r, n)
                );
            }),
            (c[s] = !0);
    ...
    function (t, n, r) {
        ...
        t.exports = function (t, n, r, f, h, m, b) {
            ...
            var S,
                ...
                _ = !1,
                T = t.prototype,
                A = T[d] || T["@@iterator"] || (h && T[h]),
                P = (!v && A) || w(h),
                E = ("Array" == n && T.entries) || A;
            if (
                (E &&
                    ((S = i(E.call(new t()))),
                    y !== Object.prototype &&
                        S.next &&
                        (l || i(S) === y || (c ? c(S, y) : "function" != typeof S[d] && a(S, d, g)),
                        u(S, j, !0, !0),
                        l && (p[j] = g))),
                "values" == h &&
                    A &&
                ...
                if (((x = { values: w("values"), keys: m ? P : w("keys"), entries: w("entries") }), b))
                    for (O in x) (!v && !_ && O in T) || s(T, O, x[O]);
                else e({ target: n, proto: !0, forced: v || _ }, x);
            return x;
        };
    },
    function (t, n, r) {
    ...
    function (t, n, r) {
        ...
        var e = r(3),
            ...
            et = function (t, n) {
                ...
                return R(r, { type: "Symbol", tag: t, description: n }), c || (r.description = n), r;
            },
            ot =
            ...
            it = function (t, n, r) {
                ...
                return (
                    ...
                    s(J, e)
                        ? (r.enumerable
                              ? (s(t, M) && t[M][e] && (t[M][e] = !1), (r = g(r, { enumerable: d(0, !1) })))
                              : (s(t, M) || B(t, M, d(1, {})), (t[M][e] = !0)),
                          rt(t, e, r))
                        : B(t, e, r)
                );
            },
            ...
            ut = function (t) {
                ...
                return (
                    !(this === G && s(J, n) && !s(Q, n)) &&
                    (!(r || !s(this, n) || !s(J, n) || (s(this, M) && this[M][n])) || r)
                );
            },
            at = function (t, n) {
                var r = y(t),
        ...
        u ||
            (T(
                (V = function () {
                    ...
                    var t = arguments.length && void 0 !== arguments[0] ? String(arguments[0]) : void 0,
                        ...
                        r = function (t) {
                            this === G && r.call(Q, t),
                                s(this, M) && s(this[M], n) && (this[M][n] = !1),
                                rt(this, n, d(1, t));
                        };
                    return c && nt && rt(G, n, { configurable: !0, set: r }), et(n, t);
                }).prototype,
                "toString",
                function () {
                    return $(this).tag;
            ...
            c &&
                ...
                i || T(G, "propertyIsEnumerable", ut, { unsafe: !0 })),
            (F.f = function (t) {
                return et(L(t), t);
            })),
            ...
            e({ target: "Object", stat: !0, forced: !u }, { getOwnPropertyNames: st, getOwnPropertySymbols: ft }),
            e(
                {
                    target: "Object",
                    stat: !0,
            ...
            V.prototype[k] || _(V.prototype, k, V.prototype.valueOf),
            C(V, "Symbol"),
            (E[M] = !0);
    },
    function (t, n, r) {
    ...
    function (t, n, r) {
        ...
        t.exports = function (t, n, r) {
            var s = n + " Iterator";
            return (t.prototype = o(e, { next: i(1, r) })), c(t, s, !1, !0), (u[s] = a), t;
        };
    },
    function (t, n, r) {
        var e = r(1);
            ...
            },
            {
                toFixed: function (t) {
                    var n,
                        ...
                        y = "0",
                        v = function (t, n) {
                            for (var r = -1, e = n; ++r < 6; ) (e += t * p[r]), (p[r] = e % 1e7), (e = s(e / 1e7));
                        },
                        d = function (t) {
                            for (var n = 6, r = 0; --n >= 0; ) (r += p[n]), (p[n] = s(r / t)), (r = (r % t) * 1e7);
                        },
                        g = function () {
                            for (var t = 6, n = ""; --t >= 0; )
                                if ("" !== n || 0 === t || 0 !== p[t]) {
        ...
        !(function (t) {
            ...
            function r(r) {
                return this.each(function () {
                    var o = t(this),
                        i = o.data("zmd.hierarchicalDisplay"),
                        c = t.extend({}, n.DEFAULTS, o.data(), "object" === e(r) && r);
                    return (
                        i || o.data("zmd.hierarchicalDisplay", (i = new n(this, c))),
                        "string" == typeof r ? i[r]() : c.action in i ? i[c.action]() : void 0
                    );
                });
            }
            (n.VERSION = "1.0.1"),
                ...
                (n.prototype.init = function () {
                    var n,
                        ...
                        u = this.options,
                        a = this._time;
                    i.addClass("zmd-hierarchical-display"),
                        c.each(function () {
                            (n = t(this).position()),
                                (r = 0.8 * n.left + n.top),
                                (e = parseFloat(r / a).toFixed(2)),
                                t(this)
                                    .css("-webkit-animation-delay", e + "s")
                                    .css("animation-delay", e + "s");
                        }),
                        (this._delay = e),
                        c.last().on("webkitAnimationEnd animationend", function () {
                            t(this).hasClass(u.animationOut) && o._complete("hidden"),
                                t(this).hasClass(u.animationIn) && o._complete("shown");
                        });
                }),
                (n.prototype.show = function () {
                    var n = this.$element,
                        r = (this.$children, this.options);
                    n.hasClass("in") ||
                        n.hasClass("zmd-hierarchical-displaying") ||
                        (this._removeAnimations(),
                        n.trigger(t.Event("show.zmd.hierarchicalDisplay")),
                        this._addAnimation(r.animationIn));
                }),
                (n.prototype.hide = function () {
                    ...
                    "hidden" === n.css("visibility") ||
                        n.hasClass("zmd-hierarchical-displaying") ||
                        (this._removeAnimations(),
                        n.trigger(t.Event("hide.zmd.hierarchicalDisplay")),
                        this._addAnimation(r.animationOut));
                }),
                ...
                (n.prototype._complete = function (n) {
                    this.$element
                        ...
                        .toggleClass("in")
                        .trigger(t.Event(n + ".zmd.hierarchicalDisplay"));
                }),
                (n.prototype._debug = function () {
                    t(document)
                        .on("show.zmd.hierarchicalDisplay", function (t) {
                ...
                (t.fn.hierarchicalDisplay = r),
                (t.fn.hierarchicalDisplay.Constructor = n),
                ...
                t(document).on("click", '[data-toggle="hierarchical-display"]', function (n) {
                    var e = t(this),
                        o = t(e.attr("data-target") || e.attr("href"));
