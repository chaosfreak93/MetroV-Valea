!(function (t) {
    ...
    function (t, n, r) {
        ...
        t.exports = function (t, n) {
            var r,
                ...
                h = t.global,
                g = t.stat;
            if ((r = h ? e : g ? e[d] || a(d, {}) : (e[d] || {}).prototype))
                for (s in n) {
                    if (
                        ((p = n[s]),
                        (l = t.noTargetGet ? (v = o(r, s)) && v.value : r[s]),
                        !f(h ? s : d + (g ? "." : "#") + s, t.forced) && void 0 !== l)
                    ) {
        ...
        o("inspectSource", function (t) {
            ...
            (t.exports = function (t, n, r, o) {
                ...
                "function" == typeof r &&
                    ...
                    t !== e
                        ? (u ? !s && t[n] && (f = !0) : delete t[n], f ? (t[n] = r) : i(t, n, r))
                        : f
                        ? (t[n] = r)
                        : a(n, r);
                ...
                return function (v, d, h, g) {
                    for (
                        var y,
                            ...
                            j = 0,
                            S = g || a,
                            E = n ? S(v, O) : r ? S(v, 0) : void 0;
                        O > j;
                        j++
                    )
                        if ((p || j in m) && ((x = w((y = m[j]), j, b)), t))
                            if (n) E[j] = x;
                            else if (x)
                                switch (t) {
                                    case 3:
    ...
    function (t, n, r) {
        ...
        (t.exports =
            ...
            function (t, n) {
                var r;
                return (
                    null !== t ? ((s.prototype = e(t)), (r = new s()), (s.prototype = null), (r[f] = t)) : (r = l()),
                    void 0 === n ? r : o(r, n)
                );
            }),
            (c[f] = !0);
        ...
        (f || s) &&
            (u = function (t) {
                var n,
                    ...
                    u = this;
                return (
                    s && (r = new RegExp("^" + u.source + "$(?!\\s)", i.call(u))),
                    f && (n = u.lastIndex),
                    (e = c.call(u, t)),
                    f && e && (u.lastIndex = u.global ? e.index + e[0].length : n),
                    s &&
                        e &&
                        e.length > 1 &&
    ...
    function (t, n, r) {
        ...
        var e = r(3),
            o = r(25).map;
        e(
            { target: "Array", proto: !0, forced: !r(34)("map") },
            {
                map: function (t) {
            ...
            return [
                ...
                function (t, i) {
                    ...
                    for (var m, w = "", O = 0, j = 0; j < x.length; j++) {
                        b = x[j];
                        for (var S = String(b[0]), E = l(p(a(b.index), d.length), 0), _ = [], I = 1; I < b.length; I++)
                            _.push(void 0 === (m = b[I]) ? m : String(m));
                        var A = b.groups;
                        if (h) {
                            var N = [S].concat(_, E, d);
                            void 0 !== A && N.push(A);
            ...
            m = function (t) {
                ...
                if ("string" == typeof f && f.length > 2)
                    if (43 === (n = (f = g(f)).charCodeAt(0)) || 45 === n) {
                        ...
                        for (c = (i = f.slice(2)).length, a = 0; a < c; a++)
            ...
            var n,
                ...
                i = function (t) {
                    if (t.hasClass("validate")) {
                        var n = t.val(),
                            r = !n.length,
                            e = !t[0].validity.badInput;
                        if (r && e) t.removeClass("valid").removeClass("invalid");
                        else {
                            var o = t.is(":valid"),
                                i = Number(t.attr("length")) || 0;
                            o && (!i || i > n.length)
                ...
                c = function () {
                    ...
                    if (n.val().length) {
                        var r = t(".hiddendiv"),
                            ...
                            o = n.css("font-size");
                        o && r.css("font-size", o),
                            e && r.css("font-family", e),
                            "off" === n.attr("wrap") && r.css("overflow-wrap", "normal").css("white-space", "pre"),
                            r.text("".concat(n.val(), "\n"));
                        var i = r.html().replace(/\n/g, "<br>");
                        r.html(i),
                            r.css("width", n.is(":visible") ? n.width() : t(window).width() / 2),
                            n.css("height", r.height());
                    }
                };
            t(e).each(function (n, r) {
                var e = t(r),
                    i = e.siblings("label, i");
                ...
                t(document).on("reset", function (n) {
                    ...
                    r.is("form") &&
                        ...
                        r.find("select.initialized").each(function (n, r) {
                            var e = t(r),
                                o = e.siblings("input.select-dropdown"),
                                i = e.children("[selected]").val();
                            e.val(i), o.val(i);
                        }));
                }),
                (r = t(".md-textarea-auto")).length &&
