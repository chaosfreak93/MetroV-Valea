...
export default class BlipManager {
    static createBlip(x: number, y: number, z: number, sprite: number, scale: number, color: number, shortRange: boolean, showCone: boolean, name: string): alt.PointBlip {
    ...
    static createBlipWithRoute(x: number, y: number, z: number, sprite: number, scale: number, color: number, shortRange: boolean, showCone: boolean, name: string): alt.PointBlip {
        const blip = new alt.PointBlip(x, y, z)
        blip.sprite = sprite;
        blip.scale = scale;
        blip.color = color;
...
function AddNewBlip(name: string, color: number, scale: number, shortRange: boolean, sprite: number, x: number, y: number, z: number) {
