...
!(function (a, b) {
    ...
    j.prototype = {
        ...
        place: function () {
            ...
            if (
                ("auto" === r &&
                    ((p = -g + o - c), (q = g + f - (o + l + c)), (r = Math.max(p, q) === q ? "top" : "bottom")),
        ...
        getClassNames: function (b) {
            var c = [],
                ...
                g = new Date();
            return (
                b.getUTCFullYear() < d || (b.getUTCFullYear() === d && b.getUTCMonth() < f)
                    ? c.push("old")
                    : (b.getUTCFullYear() > d || (b.getUTCFullYear() === d && b.getUTCMonth() > f)) && c.push("new"),
                ...
                for (var s, t = []; n.valueOf() < r; ) {
                    if (n.getUTCDay() === this.o.weekStart && (t.push("<tr>"), this.o.calendarWeeks)) {
                        var u = new Date(+n + ((this.o.weekStart - n.getUTCDay() - 7) % 7) * 864e5),
                            ...
                            w = new Date(
                                Number((w = c(v.getUTCFullYear(), 0, 1))) + ((11 - w.getUTCDay()) % 7) * 864e5,
                            ),
                            x = (v - w) / 864e5 / 7 + 1;
                        ...
                        g.hasClass("day") &&
                            ...
                            g.hasClass("old")
                                ? 0 === e
                                    ? ((e = 11), (d -= 1))
                                    : (e -= 1)
                                : g.hasClass("new") && (11 === e ? ((e = 0), (d += 1)) : (e += 1)),
                ...
                case 39:
                    ...
                    (b = 37 === a.keyCode ? -1 : 1),
                        ...
                        this.dateWithinRange(e) &&
                            ((this.focusDate = this.viewDate = e), this.setValue(), this.fill(), a.preventDefault());
                    break;
                case 38:
                case 40:
                    if (!this.o.keyboardNavigation) break;
        ...
        m = function (c) {
            ...
            return (
                this.each(function () {
                    ...
                    return "string" == typeof c && "function" == typeof i[c] && ((e = i[c].apply(i, d)), e !== b)
                        ? !1
                        : void 0;
                }),
                e !== b ? e : this
