!(function (n) {
        ...
        n.exports = function (n, t) {
            ...
            if ((e = y ? r : h ? r[d] || u(d, {}) : (r[d] || {}).prototype))
                for (s in t) {
                    if (
                        ((p = t[s]),
                        (l = n.noTargetGet ? (v = o(e, s)) && v.value : e[s]),
                        !a(y ? s : d + (h ? "." : "#") + s, n.forced) && void 0 !== l)
                    ) {
        ...
        o("inspectSource", function (n) {
            ...
            (n.exports = function (n, t, e, o) {
                var f = !!o && !!o.unsafe,
                    ...
                    s = !!o && !!o.noTargetGet;
                "function" == typeof e &&
                    ("string" != typeof t || c(e, "name") || i(e, "name", t),
                    (l(e).source = p.join("string" == typeof t ? t : ""))),
                    n !== r
                        ? (f ? !s && n[t] && (a = !0) : delete n[t], a ? (n[t] = e) : i(n, t, e))
                        : a
                        ? (n[t] = e)
                        : u(t, e);
    ...
    function (n, t, e) {
                ...
                return function (v, d, y, h) {
                    for (
                        var g,
                            ...
                            j = 0,
                            C = h || u,
                            S = t ? C(v, O) : e ? C(v, 0) : void 0;
                        O > j;
                        j++
                    )
                        if ((p || j in x) && ((b = w((g = x[j]), j, m)), n))
                            if (t) S[j] = b;
                            else if (b)
                                switch (n) {
                                    case 3:
        ...
        n.exports = { forEach: a(0), map: a(1), filter: a(2), some: a(3), every: a(4), find: a(5), findIndex: a(6) };
    },
    function (n, t) {
        n.exports = !1;
    },
    ...
    function (n, t, e) {
        ...
        (n.exports =
            ...
            function (n, t) {
                var e;
                return (
                    null !== n ? ((s.prototype = r(n)), (e = new s()), (s.prototype = null), (e[a] = n)) : (e = l()),
                    void 0 === t ? e : o(e, t)
                );
            }),
            (c[a] = !0);
    ...
    function (n, t, e) {
        ...
        n.exports = function (n, t) {
            ...
            return (
                o(n) &&
                    ("function" != typeof (e = n.constructor) || (e !== Array && !o(e.prototype))
    ...
    function (n, t, e) {
        ...
        (r = jQuery).fn.mdbTreeview = function () {
            ...
            if (n.hasClass("treeview-animated")) {
                var e = n.find(".treeview-animated-element"),
                    o = n.find(".closed");
                n.find(".nested").hide(),
                    o.off("click"),
                    o.on("click", function () {
                        var n = r(this),
                            t = n.siblings(".nested"),
                            e = n.children(".fa-angle-right");
                        return (
                            n.toggleClass("open"),
                            e.toggleClass("down"),
                            t.hasClass("active") ? t.removeClass("active").slideUp() : t.addClass("active").slideDown(),
                            !1
                        );
                    }),
                    e.off("click"),
                    e.on("click", function () {
                        ...
                        n.hasClass("opened")
                            ...
                            : (e.removeClass("opened"), n.addClass("opened"));
                    });
            }
            if (n.hasClass("treeview-colorful")) {
                var i = n.find(".treeview-colorful-element"),
                    c = n.find(".treeview-colorful-items-header");
                n.find(".nested").hide(),
                    c.off("click"),
                    c.on("click", function () {
                        var n = r(this),
                            t = n.siblings(".nested"),
                            e = n.children(".fa-plus-circle"),
                            o = n.children(".fa-minus-circle");
                        n.toggleClass("open"),
                            e.removeClass("fa-plus-circle"),
                            e.addClass("fa-minus-circle"),
                            o.removeClass("fa-minus-circle"),
                            o.addClass("fa-plus-circle"),
                            t.hasClass("active") ? t.removeClass("active").slideUp() : t.addClass("active").slideDown();
                    }),
                    i.off("click"),
                    i.on("click", function () {
                        ...
                        n.hasClass("opened")
                            ...
                            : (i.removeClass("opened"), n.addClass("opened"));
                    });
            }
        };
    },
