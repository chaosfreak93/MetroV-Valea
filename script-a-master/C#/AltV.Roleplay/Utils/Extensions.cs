...
namespace Altv_Roleplay.Utils
{
    public static class Extensions
    {
        ...
        public static double distance(this Position pos1, Position pos2) {
            return Math.Sqrt(Math.Pow(pos1.X - pos2.X, 2) + Math.Pow(pos1.Y - pos2.Y, 2) + Math.Pow(pos1.Z - pos2.Z, 2));
        }

        public static double distance2d(this Position pos1, Position pos2) {
        ...
        public static void SetVehicleEngineHoodState(this IVehicle vehicle, bool isOpen) //True = offen, false = Zu
        {
            var myVehicle = (ClassicVehicle) vehicle;
            if (myVehicle == null || !myVehicle.Exists) return;

            myVehicle.EngineHood = isOpen;
        }

        public static bool GetVehicleEngineHoodState(this IVehicle vehicle) {
            var myVehicle = (ClassicVehicle) vehicle;
            if (myVehicle == null || !myVehicle.Exists) return false;

            return myVehicle.EngineHood;
        }
        ...
        public static void SetPlayerIsCuffed(this IPlayer player, string cuffType, bool isCuffed) {
            //cuffType = handcuffs | ropecuffs | footcuffs
        ...
        public static void SetPlayerIsUnconscious(this IPlayer player, bool isUnconscious) {
            ...
            player.SetSyncedMetaData("IsUnconscious", isUnconscious);
        }
        ...
        public static bool HasPlayerFootcuffs(this IPlayer player) {
            if (player == null || !player.Exists) return false;

            return player.GetSyncedMetaData("HasFootCuffs", out bool footCuffs) ? footCuffs : false;
        }
        ...
        //Minijob Zeug
        public static void
            SetPlayerCurrentMinijob(this IPlayer player, string minijobName) //Um den Minijob zu speichern (bspw. Holzfäller, Geldtransporter)
        {
            var myPlayer = (ClassicPlayer) player;
            if (myPlayer == null || !myPlayer.Exists) return;
        ...
        public static void
            SetPlayerCurrentMinijobActionCount(this IPlayer player,
                long count) //Verwendung: ATM aufgefüllt => Count 1 höher => next ATM => Count höhr => Count == max == fertig.
        {
            var myPlayer = (ClassicPlayer) player;
            if (myPlayer == null || !myPlayer.Exists) return;
        ...
        public static long GetPlayerCurrentMinijobActionCount(this IPlayer player) {
            ...
            return myPlayer.CurrentMinijobActionCount;
        }
        ...
        public static long GetPlayerCurrentMinijobRouteId(this IPlayer player) {
            ...
            return myPlayer.CurrentMinijobRouteId;
        }
