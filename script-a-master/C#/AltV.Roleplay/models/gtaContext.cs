...
namespace Altv_Roleplay.models
{
    public class gtaContext : DbContext
    {
        ...
        public virtual DbSet<Server_Dropped_Items> Server_Dropped_Items { get; set; }
        ...
        public virtual DbSet<Server_Tablet_Advertisements> Server_Tablet_Advertisements { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) {
            if (!optionsBuilder.IsConfigured) {
                //Lokal
                var connectionStr =
                    $"server={Constants.DatabaseConfig.Host};port={Constants.DatabaseConfig.Port};user={Constants.DatabaseConfig.User};password={Constants.DatabaseConfig.Password};database={Constants.DatabaseConfig.Database}";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder) {
            ...
            modelBuilder.Entity<Accounts>(entity =>
            {
                ...
                entity.Property(e => e.playerName).IsRequired().HasColumnName("username").HasMaxLength(64).IsUnicode(false)
            ...
            modelBuilder.Entity<Server_Doors>(entity =>
            {
                ...
                entity.Property(e => e.id).HasColumnName("id").HasColumnType("int(11)");
                entity.Property(e => e.name).HasColumnName("name").HasMaxLength(64);
                entity.Property(e => e.doorHash).HasColumnName("doorHash").HasMaxLength(64);
                entity.Property(e => e.posX).HasColumnName("posX");
                entity.Property(e => e.posY).HasColumnName("posY");
                entity.Property(e => e.posZ).HasColumnName("posZ");
                entity.Property(e => e.doorHash2).HasColumnName("doorHash2").HasMaxLength(64);
                entity.Property(e => e.posX2).HasColumnName("posX2");
                entity.Property(e => e.posY2).HasColumnName("posY2");
                entity.Property(e => e.posZ2).HasColumnName("posZ2");
            ...
            modelBuilder.Entity<Server_Dropped_Items>(entity =>
            {
                entity.HasKey(e => e.id);
                entity.ToTable("server_dropped_items", Constants.DatabaseConfig.Database);
                entity.HasIndex(e => e.id);
                entity.Property(e => e.id).HasColumnName("id").HasColumnType("int(11)");
                entity.Property(e => e.dimension).HasColumnName("dimension").HasColumnType("int(11)");
                entity.Property(e => e.itemName).HasColumnName("itemName").HasMaxLength(128);
                entity.Property(e => e.itemAmount).HasColumnName("itemAmount").HasColumnType("int(11)");
                entity.Property(e => e.pos).HasColumnName("pos").HasConversion(
                    v => JsonConvert.SerializeObject(v),
                    v => JsonConvert.DeserializeObject<Position>(v));
                entity.Property(e => e.droppedTimestamp).HasColumnName("droppedTimestamp");
            });
