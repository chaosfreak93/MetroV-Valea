...
{
    internal class ServerCompanys
    {
        public static List<Server_Companys> ServerCompanysData_ = new();
        public static List<Server_Company_Members> ServerCompanysMember_ = new();
        public static List<Logs_Company> LogsCompany_ = new();
