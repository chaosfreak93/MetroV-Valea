...
{
    internal class CharactersLicenses
    {
        public static List<Characters_Licenses> CharactersLicenses_ = new();
        public static List<Server_Licenses> ServerLicenses_ = new();

        public static void CreateCharacterLicensesEntry(int charId, bool pkw, bool lkw, bool bike, bool boat, bool fly, bool helicopter,
            bool passengertransport, bool weaponlicense) {
            if (charId <= 0) return;
